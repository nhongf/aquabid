...
function get_search_form($echo = true) {
	...
	<div><label class="screen-reader-text" for="s">' . __('Nhập từ cần tìm:') . '</label>
	<input type="text" onblur="if (this.value==\'\') this.value=\'' . get_search_query() . '\';" onfocus="if (this.value==\'' . get_search_query() . '\') this.value=\'\';" value="' . get_search_query() . '" name="s" id="s" />
